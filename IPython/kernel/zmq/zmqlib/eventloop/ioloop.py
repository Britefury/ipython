...
if sys.platform.startswith('java'):
    ...
    class ZMQPoller(object):
        ...
        def _map_events(events):
            """translate IOLoop.READ/WRITE/ERROR event masks into zmq.ZMQ_POLLIN/OUT/ERR"""
            z_events = 0
        ...
        def _remap_events(z_events):
            """translate zmq.ZMQ_POLLIN/OUT/ERR event masks into IOLoop.READ/WRITE/ERROR"""
            events = 0
            if z_events & ZMQ_POLLIN:
                events |= IOLoop.READ
